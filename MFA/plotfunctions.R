...
partial_plot<-function(group_num,data,data2,names){
  p = ggplot2::ggplot()+
    ...
    ggplot2::theme(plot.title = ggplot2::element_text(size=12, face="bold",vjust=0.05,color="grey40"),
                   axis.title.x = ggplot2::element_text(size=12, face="bold",vjust=-0.05,color="grey40"),
                   axis.title.y = ggplot2::element_text(size=12, face="bold",vjust=0.05,color="grey40"),
